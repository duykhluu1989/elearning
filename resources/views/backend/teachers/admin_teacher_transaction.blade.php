...
@section('page_heading', 'Lịch Sử Hoa Hồng Giảng Viên - ' . $teacher->username)
    ...
    $gridView->setTools([
        function() {
            echo \App\Libraries\Helpers\Html::a('Quay Lại', [
                'href' => \App\Libraries\Helpers\Utility::getBackUrlCookie(action('Backend\UserController@adminUserTeacher')),
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content box" id="SubmitPaymentModalContent">
                ...
                <div class="modal-body">
                    <form action="{{ action('Backend\TeacherController@paymentTeacher', ['id' => $teacher->id]) }}" method="post" id="SubmitPaymentModalForm">

                        @include('backend.teachers.partials.payment_teacher_form')
