...
@section('page_heading', 'Chứng Chỉ')
    ...
    $gridView->setTools([
        function() {
            echo \App\Libraries\Helpers\Html::a(\App\Libraries\Helpers\Html::i('', ['class' => 'fa fa-plus fa-fw']), [
                'href' => action('Backend\CertificateController@createCertificate'),
                'class' => 'btn btn-primary',
                'data-container' => 'body',
                'data-toggle' => 'popover',
                'data-placement' => 'top',
                'data-content' => 'Chứng Chỉ Mới',
            ]);
        },
        function() {
            echo \App\Libraries\Helpers\Html::button(\App\Libraries\Helpers\Html::i('', ['class' => 'fa fa-trash fa-fw']), [
                ...
                'data-placement' => 'top',
                'data-content' => 'Xóa',
                'value' => action('Backend\CertificateController@controlDeleteCertificate'),
                'style' => 'display: none',
            ]);
        },
    ]);
