        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="form-group{{ $errors->has('user_name') ? ' has-error': '' }}">
                    <label>Chuyên Gia <i>(bắt buộc)</i></label>
                    <input type="text" class="form-control" id="UserInput" name="user_name" placeholder="name - email" value="{{ old('user_name', (!empty($article->user_id) ? (!empty($article->user) ? ($article->user->profile->name . ' - ' . $article->user->email) : '') : '')) }}" />
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    @if(empty($article->id))
                                        <span class="input-group-addon">{{ url('article') }}/</span>
                                    @else
                                        <span class="input-group-addon">{{ url('article', ['id' => $article->id]) }}/</span>
                                    @endif
