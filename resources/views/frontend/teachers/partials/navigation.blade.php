<ul class="list_navLeft">
    ...
    <li class="{{ (request()->is('teacher/transaction') ? 'active' : '') }}"><a href="{{ (request()->is('teacher/transaction') ? 'javascript:void(0)' : action('Frontend\TeacherController@adminTeacherTransaction')) }}">@lang('theme.commission_history')</a></li>
</ul>