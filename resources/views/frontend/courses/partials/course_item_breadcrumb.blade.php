        ...
        <div class="row">
            <div class="col-lg-12">
                <ol class="breadcrumb">
                    ...
                    @endforeach
                    <li><a href="{{ action('Frontend\CourseController@detailCourse', ['id' => $course->id, 'slug' => \App\Libraries\Helpers\Utility::getValueByLocale($course, 'slug')]) }}#section_chitiet">{{ \App\Libraries\Helpers\Utility::getValueByLocale($course, 'name') }}</a></li>
