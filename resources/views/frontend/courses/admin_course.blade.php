...
@section('page_heading', $listTitle)
...
@section('section')
    ...
    @include('frontend.layouts.partials.breabcrumb', ['breabcrumbTitle' => $listTitle])
                        ...
                        <div class="navleft">
                            ...
                            <ul class="list_navLeft">
                                @foreach($listCategories as $listCategory)
                                    <li><a href="{{ action('Frontend\CourseController@detailCategory', ['id' => $listCategory->id, 'slug' => \App\Libraries\Helpers\Utility::getValueByLocale($listCategory, 'slug')]) }}">{{ \App\Libraries\Helpers\Utility::getValueByLocale($listCategory, 'name') }}</a></li>
                                @endforeach
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                        <div class="main_content">
                            <ul class="nav nav-tabs tabs_khoahoc">
                                <li><a class="disabled" href="javascript:void(0)"><h3>{{ $listTitle }}</h3></a></li>
                                <li><a class="disabled" href="javascript:void(0)">@lang('theme.sort_by')</a></li>
                                <li<?php echo ($sort == null ? ' class="active"' : '') ?>><a class="disabled" href="{{ $sort == null ? 'javascript:void(0)' : action('Frontend\CourseController@adminCourse') }}">@lang('theme.newest')</a></li>
                                <li<?php echo ($sort == 'highlight' ? ' class="active"' : '') ?>><a class="disabled" href="{{ $sort == 'highlight' ? 'javascript:void(0)' : action('Frontend\CourseController@adminCourse', ['sort' => 'highlight']) }}">@lang('theme.highlight')</a></li>
                                <li<?php echo ($sort == 'promotion' ? ' class="active"' : '') ?>><a class="disabled" href="{{ $sort == 'promotion' ? 'javascript:void(0)' : action('Frontend\CourseController@adminCourse', ['sort' => 'promotion']) }}">@lang('theme.promotion')</a></li>
                                <li<?php echo ($sort == 'free' ? ' class="active"' : '') ?>><a class="disabled" href="{{ $sort == 'free' ? 'javascript:void(0)' : action('Frontend\CourseController@adminCourse', ['sort' => 'free']) }}">@lang('theme.free')</a></li>
                            </ul>
