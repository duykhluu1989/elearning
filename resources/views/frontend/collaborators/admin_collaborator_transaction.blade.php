                        ...
                        <div class="main_content">
                            <div class="table-responsive">
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tbody>
                                    <form action="{{ action('Frontend\CollaboratorController@adminCollaboratorTransaction') }}" id="CollaboratorTransactionFilterForm" method="get">
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                ?>
                                                <select class="form-control" name="type" id="CollaboratorTransactionTypeFilter">
                                                    <option value=""></option>
                                    ...
                                    @foreach($transactions as $transaction)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if($transaction->type == \App\Models\CollaboratorTransaction::TYPE_DOWNLINE_INCOME_DB)
                                                    {{ $transaction->downlineCollaborator->profile->name }}
                                                @endif
                                            </td>
                                            <td>
...
@push('scripts')
    <script type="text/javascript">
        $('#CollaboratorTransactionTypeFilter').change(function() {
            $('#CollaboratorTransactionFilterForm').submit();
        });
    </script>
@endpush