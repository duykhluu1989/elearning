                    ...
                    <div class="col-lg-12">
                        <div class="main_content mb60">
                            ...
                            @if(auth()->guest())
                                ...
                                <div class="tab-content tabs_info_content mb60">
                                    <div class="row">
                                        <div class="col-lg-8 col-lg-offset-2">
                                            <div id="section_giangvien" class="tab-pane fade in active">
                                                <form action="{{ action('Frontend\UserController@registerTeacher') }}" id="PersonalTeacherSignUpForm" method="POST" role="form" class="frm_thongtinctv">
...
@if(auth()->guest())
    @push('scripts')
        <script type="text/javascript">
            ...
            $('#PersonalTeacherSignUpForm').submit(function(e) {
                e.preventDefault();
